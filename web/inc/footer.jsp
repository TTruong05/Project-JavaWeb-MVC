...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
    <footer class="bg-light py-4 pb-0 p-5">
      <div class="footer p-5 pb-0">
        <div class="row">
          <div class="col-md-3">
            ...
            <p class="mt-2 mb-1">
              ...
              <a href="#" class="text-dark fw-bold">Terms & Conditions</a>
              and <a href="#" class="text-dark fw-bold">Privacy Policy</a>.
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                ...
                <ul>
                  ...
                  <li><a href="">Access to Sport</a></li>
                  ...
                  <li><a href="">Innovation House</a></li>
                  <li><a href="">AD's Blog</a></li>
                </ul>
              </div>
              <div class="col-md-3">
                <h6>Follow Us</h6>
          ...
          <div class="row mt-5">
            <div class="col-md-12 text-center">
              <p class="small">
                &copy; ADIAS LLC. <a href="#">Privacy Policy</a> |
                <a href="#">Terms</a>
              </p>
            </div>
          </div>
